...
const WALLS = [
  { label: 'Corner', value: 'WallCoin' },
  { label: 'Slab', value: 'WallDalle' },
  { label: 'Tension', value: 'WallTension' },
  { label: 'Roof', value: 'WallToit' },
  { label: 'Dynamic', value: 'WallDynamic' },
  { label: 'Door', value: 'WallPorte' },
  { label: 'Titanic', value: 'WallDevers' },
  { label: 'Diedre', value: 'WallDiedre' },
  { label: 'Angle', value: 'WallAngle' },
  { label: 'Angle 2', value: 'WallAngle2' },
  { label: 'Easy', value: 'WallEasy' },
];
      ...
      {phase === 3 && (
        <ScrollView style={{ flex: 1 }}>
          ...
          <View style={styles.creator_row}>
            ...
            <Text style={styles.creator_subtitle}>type</Text>
            <View style={styles.creator_row}>
              {WALL_TYPES.map(w => (
                <TouchableOpacity
                  key={w.value}
